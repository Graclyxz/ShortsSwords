...
public class ShortswordsModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_SHORTS_SWORDS = REGISTRY.register("tab_shorts_swords",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.shortswords.tab_shorts_swords")).icon(() -> new ItemStack(ShortswordsModItems.NETHERITE_SHORT_SWORD.get())).displayItems((parameters, tabData) -> {
